        ...
        <div key={product.id}>
          <div className="space-y-4 flex flex-col flex-1 h-full">
            <div className="aspect-w-3 aspect-h-2">
              <img className="object-cover shadow-lg rounded-lg" src={product.image} alt="" />
            </div>

            <div className="space-y-2 flex flex-col flex-1">
              <div className="text-sm leading-6 font-medium space-y-1 flex-1">
                <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${isPaymentEnabled ? 'bg-purple-100 text-purple-800' : 'bg-yellow-100 text-yellow-800'}`}>
