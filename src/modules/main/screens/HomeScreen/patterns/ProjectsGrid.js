    ...
    <div className="rounded-lg bg-gray-200 overflow-hidden shadow divide-y divide-gray-200 sm:divide-y-0 sm:grid sm:grid-cols-2 sm:gap-px">
      {projects.map((project, actionIdx) => {
        ...
        return (
          ...
          >
            <div>
              <span className="safe rounded-lg inline-flex p-3 ring-4 ring-white text-gray-700 bg-gray-50 group-hover:bg-yellow-50 group-hover:text-yellow-700">
            ...
            <div className="mt-8">
              <h3 className="text-lg font-medium">
                <a href={link} className="focus:outline-none">
                  ...
                  {project.name}
                  {project.new && (
                    <span className="text-accent-900"> (new)</span>
                  )}
                </a>
              </h3>
